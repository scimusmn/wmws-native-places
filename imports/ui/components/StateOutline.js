    ...
    return (
      <div className={'state-outline ' + (this.props.playState ?  'home' : 'selection')}>
        ...
        <svg id='StateMN' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 995.58 1146.08'>
          ...
          <text id='Anoka-txt' className='cls-3' transform='translate(494.85 805.93)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Mendota-txt' className='cls-3' transform='translate(526.04 870.81)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Wabasha-txt' className='cls-3' transform='translate(688.98 982.18)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Kasota-txt' className='cls-3' transform='translate(406.08 993.01)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Kandiyohi-txt' className='cls-3' transform='translate(266.92 817.68)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Minnehaha-txt' className='cls-3' transform='translate(519.17 864.99)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Shakopee-txt' className='cls-3' transform='translate(472.73 889.24)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Chanhassen-txt' className='cls-3' transform='translate(472.73 875.56)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Minnetonka-txt' className='cls-3' transform='translate(482.67 864.24)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='LakeCalhoun-txt' className='cls-3' transform='translate(503.08 855.68)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Waconia-txt' className='cls-3' transform='translate(434.67 878.49)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Wayzata-txt' className='cls-3' transform='translate(475.67 852.74)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Mankato' className='cls-3' transform='translate(401.21 1021.41)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Owatonna-txt' className='cls-3' transform='translate(514.48 1037.01)' textAnchor='middle' dominantBaseline='middle'>XX</text>
          <text id='Chaska-txt' className='cls-3' transform='translate(461.67 890.49)' textAnchor='middle' dominantBaseline='middle'>XX</text>
